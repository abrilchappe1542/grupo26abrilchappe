...
void menuPunto2(){
    ...
    while (seguir == 1){
        ...
        printf("2. Retornar en una estructura todos los nodos interiores (los que no son ni hojas ni raiz). \n");
        printf("3. Buscar todas las ocurrencias de una clave dentro del arbol y retornar la posicion de cada ocurrencia (puntero al nodo). \n");
