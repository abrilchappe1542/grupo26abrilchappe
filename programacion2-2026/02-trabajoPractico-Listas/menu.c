...
void menuPunto6(){
    ...
    while(seguir == 1){
        ...
        printf("La complejidad algoritmica de la solucion es O(n^2) porque la funcion utiliza dos bucles while anidados y los cuales dependen del tamaño del problema");
